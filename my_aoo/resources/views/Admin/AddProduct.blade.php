                ...
                <div class="aa-myaccount-area">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form action="{{ route('RegisterProductsAdmin') }}" method="POST" 
                                  enctype="multipart/form-data" class="aa-login-form">
                                @csrf
                                <div class="form-group mb-3">
                                    <input type="text" placeholder="Product Name" id="name" class="form-control" name="name"
                                           required autofocus>
                                    @if ($errors->has('name'))
                                ...
                                <div class="form-group mb-3">
                                    <input type="file" placeholder="Choose File" id="phone" class="form-control" name="image"
                                           required autofocus>
                                    @if ($errors->has('phone'))
                                ...
                                <!-- <div class="form-group mb-3">
                                    <input type="text" placeholder="categorys" id="categorys" class="form-control"
                                           name="categorys" required>
